...
## 🧠 Обо мне
- На самом деле я люблю многие вещи, но самые любимые из них:
...
- 💡 **Закончил участие** в хакатоне в роли **тимлида** команды, которая разрабатывает **AI-тренер выступлений** — инструмент для улучшения навыков публичных выступлений с помощью искусственного интеллекта.
- В итоге мы занаяли 4 место)




# С каким лицом я оформлял репозиторий
